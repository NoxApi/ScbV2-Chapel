...
export class Scbv2Chapel__balancesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Scbv2Chapel__lockChoicesResult {
  value0: BigInt;
  value1: BigInt;
...
export class Scbv2Chapel__nftResult {
  value0: i32;
  value1: i32;
  value2: BigInt;
...
export class Scbv2Chapel__rewardDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Scbv2Chapel extends ethereum.SmartContract {
  static bind(address: Address): Scbv2Chapel {
    return new Scbv2Chapel("Scbv2Chapel", address);
  }

  BASE_EXP(): BigInt {
    let result = super.call("BASE_EXP", "BASE_EXP():(uint256)", []);

    return result[0].toBigInt();
  }

  try_BASE_EXP(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("BASE_EXP", "BASE_EXP():(uint256)", []);
    if (result.reverted) {
  ...
  balances(param0: BigInt): Scbv2Chapel__balancesResult {
    let result = super.call(
      "balances",
      "balances(uint256):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );

    return new Scbv2Chapel__balancesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_balances(
    param0: BigInt
  ): ethereum.CallResult<Scbv2Chapel__balancesResult> {
    let result = super.tryCall(
      "balances",
      "balances(uint256):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new Scbv2Chapel__balancesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  lockChoices(param0: BigInt): Scbv2Chapel__lockChoicesResult {
    let result = super.call(
      "lockChoices",
    ...
    return new Scbv2Chapel__lockChoicesResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_lockChoices(
    param0: BigInt
  ): ethereum.CallResult<Scbv2Chapel__lockChoicesResult> {
    let result = super.tryCall(
      "lockChoices",
      "lockChoices(uint256):(uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Scbv2Chapel__lockChoicesResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  nft(param0: BigInt): Scbv2Chapel__nftResult {
    let result = super.call("nft", "nft(uint256):(uint8,uint8,uint256)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);

    return new Scbv2Chapel__nftResult(
      result[0].toI32(),
      result[1].toI32(),
      result[2].toBigInt()
    );
  ...
  try_nft(param0: BigInt): ethereum.CallResult<Scbv2Chapel__nftResult> {
  ...
  rewardData(param0: Address): Scbv2Chapel__rewardDataResult {
    let result = super.call(
      "rewardData",
    ...
    return new Scbv2Chapel__rewardDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_rewardData(
    param0: Address
  ): ethereum.CallResult<Scbv2Chapel__rewardDataResult> {
    let result = super.tryCall(
      "rewardData",
      "rewardData(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Scbv2Chapel__rewardDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  unlocks(param0: BigInt, param1: BigInt): BigInt {
    let result = super.call("unlocks", "unlocks(uint256,uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(param0),
  ...
  try_unlocks(param0: BigInt, param1: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "unlocks",
      "unlocks(uint256,uint256):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(param0),
        ethereum.Value.fromUnsignedBigInt(param1)
      ]
...
export class ReclaimLocksCall extends ethereum.Call {
  get inputs(): ReclaimLocksCall__Inputs {
    return new ReclaimLocksCall__Inputs(this);
  }

  get outputs(): ReclaimLocksCall__Outputs {
    return new ReclaimLocksCall__Outputs(this);
  }
}

export class ReclaimLocksCall__Inputs {
  _call: ReclaimLocksCall;

  constructor(call: ReclaimLocksCall) {
    this._call = call;
  }
  ...
  get _weeks(): Array<BigInt> {
    return this._call.inputValues[1].value.toBigIntArray();
  }
}

export class ReclaimLocksCall__Outputs {
  _call: ReclaimLocksCall;
